...
public class SEBClientInfo
{
    ...
    public static bool SetSebClientConfiguration()
    {
        ...
        Console.WriteLine(tempLogStringBuilder.ToString(), null, null);
        ...
        Console.WriteLine(userInfo.ToString(), null, null);
    ...
    public static void SetSebPaths()
    {
        ...
        Console.WriteLine("getting application executable directory");
        ApplicationExecutableDirectory = Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location);
