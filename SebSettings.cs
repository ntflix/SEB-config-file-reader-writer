...
public class SEBSettings
{
    ...
    */
    ...
    public static bool StoreDecryptedSebClientSettings(byte[] sebSettings)
    {
        ...
        if (sebSettings != null)
        {
            ...
            try
            {
                ...
                {
                    Console.WriteLine("The .seb file could not be decrypted. ", null, null, "");
                    return false;
                }
            }
            catch (Exception streamReadException)
            {
                ...
                Console.WriteLine("The .seb file could not be decrypted. ", null, streamReadException, streamReadException.Message);
                return false;
            }
        }
    ...
    // *********************************************
    public static System.Collections.Generic.Dictionary<string, object> ReadSebConfigurationFile(String fileName, bool forEditing, ref string filePassword, ref bool passwordIsHash, ref X509Certificate2 fileCertificateRef)
    {
        ...
        try
        {
            ...
            if (newSettings == null)
            {
                throw new Exception("The .seb file could not be read: ");
            }
        }
        catch (Exception streamReadException)
        {
            // Let the user know what went wrong
            Console.WriteLine("The .seb file could not be read: ", null, streamReadException, streamReadException.Message);
    ...
    public static bool WriteSebConfigurationFile(String fileName, string filePassword, bool passwordIsHash, X509Certificate2 fileCertificateRef, bool useAsymmetricOnlyEncryption, SEBSettings.sebConfigPurposes configPurpose, bool forEditing = false)
    {
        ...
        {
            // Let the user know what went wrong
            Console.WriteLine("The configuration file could not be written: ", null, streamWriteException, streamWriteException.Message);
            return false;
        }
        return true;
    }
